...
/**
 * This is the model class for table "tblderivative_technical_specification_base".
 *
 ...
 */
class TblderivativeTechnicalSpecificationBase extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tblderivative_technical_specification_base';
    }
    ...
    /**
     * @inheritdoc
     * @return TblderivativeTechnicalSpecificationBaseQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new TblderivativeTechnicalSpecificationBaseQuery(get_called_class());
    }
}
