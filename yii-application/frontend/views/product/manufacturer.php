...
<section class="audi-title">
    <div class="container">
        <div class="col-md-12">
            <h1><img src="../../web/images/audi_logo.png">MANUFACTURER leasing deals</h1>
...
<section class="manufa_deals-bg image-section">
    <div class="container">
        <div class="col-md-5 pull-right image item">
            <img src="../../web/images/audi-blue.jpg">
        </div>
        ...
        <div class="col-md-7">
            ...
            <div class="choose_model">
                <form>
                    ...
                    <div class="form-group">
                        <p>Haven’t decided? <a href="#">Get in touch and let us help you find an Audi</a></p>
                    </div>
            ...
            <div class="sm_carinfo">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="sm_cardtl">
                            <div class="sm_cardtlimg">
                                <figure> <img class="img-responsive" src="../../web/images/srchm_car1.jpg"></figure>
                                <figcaption>XXXX deals available</figcaption>
                            </div>
                            <div class="sm_carcontt">
                                <div class="sm_carnamsap">
                                    <img src="../../web/images/sp_ofrline.png">
                                </div>
                                <div class="sm_carnam">
                                    <h3>Audi A1</h3>
                                </div>
                                ...
                                <div class="sm_carrngviewbtn">
                                    <button type="submit" class="hm_redbtns">View Range <img src="../../web/images/hmright_arrow.png"> </button>
                                </div>
                            </div>
                        </div><!--sm_caridtl-->
                    </div>    <!--col-lg-4-->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="sm_cardtl">
                            <div class="sm_cardtlimg">
                                <figure> <img class="img-responsive" src="../../web/images/srchm_car2.jpg"></figure>
                                <figcaption>XXXX deals available</figcaption>
                            </div>
                            <div class="sm_carcontt">
                                <div class="sm_carnamsap">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="sm_cardtl">
                            <div class="sm_cardtlimg">
                                <figure> <img class="img-responsive" src="../../web/images/srchm_car3.jpg"></figure>
                                <figcaption>XXXX deals available</figcaption>
                            </div>
                            <div class="sm_carcontt">
                                <div class="sm_carnamsap">
            ...
            <div class="sm_carinfo">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="sm_cardtl">
                            <div class="sm_cardtlimg">
                                <figure> <img class="img-responsive" src="../../web/images/srchm_car4.jpg"></figure>
                                <figcaption>XXXX deals available</figcaption>
                            </div>
                            <div class="sm_carcontt">
                                <div class="sm_carnamsap">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="sm_cardtl">
                            <div class="sm_cardtlimg">
                                <figure> <img class="img-responsive" src="../../web/images/srchm_car5.jpg"></figure>
                                <figcaption>XXXX deals available</figcaption>
                            </div>
                            <div class="sm_carcontt">
                                <div class="sm_carnamsap">
            ...
            <div class="sm_carinfo">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="sm_cardtl">
                            <div class="sm_cardtlimg">
                                <figure> <img class="img-responsive" src="../../web/images/srchm_car6.jpg"></figure>
                                <figcaption>XXXX deals available</figcaption>
                            </div>
                            <div class="sm_carcontt">
                                <div class="sm_carnamsap">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="sm_cardtl">
                            <div class="sm_cardtlimg">
                                <figure> <img class="img-responsive" src="../../web/images/srchm_car7.jpg"></figure>
                                <figcaption>XXXX deals available</figcaption>
                            </div>
                            <div class="sm_carcontt">
                                <div class="sm_carnamsap">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="sm_cardtl">
                            <div class="sm_cardtlimg">
                                <figure> <img class="img-responsive" src="../../web/images/srchm_car8.jpg"></figure>
                                <figcaption>XXXX deals available</figcaption>
                            </div>
                            <div class="sm_carcontt">
                                <div class="sm_carnamsap">
